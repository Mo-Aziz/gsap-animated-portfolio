...
/**
 * Item in *TechList → Default → Primary → Tech stack1*
 */
export interface TechListSliceDefaultPrimaryTechStackItem {
  /**
   * Tech Name field in *TechList → Default → Primary → Tech stack1*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Tech Color field in *TechList → Default → Primary → Tech stack1*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
...
/**
 * Item in *TechList → Default → Primary → Tech stack2*
 */
export interface TechListSliceDefaultPrimaryTechStack2Item {
  /**
   * Tech Name field in *TechList → Default → Primary → Tech stack2*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_stack2[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tech_name: prismic.KeyTextField;

  /**
   * Tech Color field in *TechList → Default → Primary → Tech stack2*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_stack2[].tech_color
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Tech stack1 field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
  ...
  /**
   * Tech stack2 field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_stack2[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  tech_stack2: prismic.GroupField<
    Simplify<TechListSliceDefaultPrimaryTechStack2Item>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TechListSliceDefaultPrimaryTechStack2Item,
