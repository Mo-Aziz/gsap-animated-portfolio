...
/**
 * Item in *Experience → Default → Primary → Details*
 */
export interface ExperienceSliceDefaultPrimaryDetailsItem {
  /**
   * Title field in *Experience → Default → Primary → Details*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.details[].title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;

  /**
   * Time Period field in *Experience → Default → Primary → Details*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.details[].time_period
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  time_period: prismic.KeyTextField;

  /**
   * Institution field in *Experience → Default → Primary → Details*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.details[].institution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  institution: prismic.KeyTextField;

  /**
   * Description field in *Experience → Default → Primary → Details*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.details[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
}
...
export interface ExperienceSliceDefaultPrimary {
  ...
  /**
   * Details field in *Experience → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.details[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  details: prismic.GroupField<
    Simplify<ExperienceSliceDefaultPrimaryDetailsItem>
  >;
}
...
export interface ProjectInfoSliceDefaultPrimary {
  /**
   * LiveProject field in *ProjectInfo → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: project_info.default.primary.liveproject
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  liveproject: prismic.KeyTextField;

  /**
   * LiveProjectLink field in *ProjectInfo → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project_info.default.primary.liveprojectlink
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  liveprojectlink: prismic.LinkField;

  /**
   * GitHubRepo field in *ProjectInfo → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: project_info.default.primary.githubrepo
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  githubrepo: prismic.KeyTextField;

  /**
   * GitHubRepoLink field in *ProjectInfo → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project_info.default.primary.githubrepolink
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  githubrepolink: prismic.LinkField;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ExperienceSlice,
      ExperienceSliceDefaultPrimaryDetailsItem,
