...
export default function Button({
  ...
  return (
    <PrismicNextLink
      field={linkField}
      className={clsx(
        "group relative text-slate-800 flex w-fit items-center justify-center overflow-hidden rounded-md border-2 border-slate-900 bg-slate-50  px-4 py-2 font-bold transition-transform ease-out  hover:scale-105  no-underline",
        className
      )}
    >
